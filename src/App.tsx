...
import ExampleForm from './pages/example/form/example';
import './App.css';
import 'bootstrap/dist/css/bootstrap.min.css';

const App: React.FC = () => {
  const [exampleForm, openExampleForm] = useState(false);
    ...
    <div className="App">
      <header className="App-header">
        <img
          ...
          alt="logo"
        />
        <p>React Bootstrap Biolerplate ✨</p>
        <Button
          onClick={() => openExampleForm(!exampleForm)}
